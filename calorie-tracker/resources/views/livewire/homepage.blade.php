<div class="min-h-screen bg-gradient-to-b from-indigo-50 via-purple-50 to-white">

    {{-- Sticky header --}}
    <div class="sticky top-0 z-20 bg-white/70 backdrop-blur-md border-b border-gray-200/60">
        <div class="mx-auto max-w-5xl px-6 md:px-10 py-4">
            <div class="flex items-center justify-between flex-wrap gap-3">
                <div>
                    <h1 class="text-2xl md:text-3xl font-bold text-gray-900">Calorie Tracker</h1>
                    <p class="text-sm text-gray-500">Log food quickly. Stay consistent.</p>
                </div>
                <div class="px-4 py-2 rounded-full bg-white/80 backdrop-blur border border-gray-200 shadow-sm text-sm font-medium text-gray-700">
                    {{ now()->format('l, M j') }}
                </div>
            </div>
        </div>
            ...
            <section class="relative overflow-hidden rounded-2xl bg-white/80 backdrop-blur border border-gray-200 p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
                ...
                <div class="relative z-10">
                    ...
                    <div class="mb-6">
                        ...
                        @if($todayCalories === 0)
                            <p class="text-sm text-gray-400 mt-1">Start logging to track your day</p>
                        @endif
                    </div>
